	...
	<nav class="fh5co-nav" >
		<div class="top-menu">
			<div class="">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="#">Rent<span>market</span></a></div>
					</div>
							...
							<form>
								<div class="form-group">
									<label class="checkbox-inline">
									  <input type="radio" name="category" value="1"> Living Space
									</label>
									<label class="checkbox-inline">
									  <input type="radio" name="category" value="2"> Working Space
									</label>
									<label class="checkbox-inline">
									  <input type="radio" name="category" value="2"> Leasure Space
									</label>
							  </div>
		...
		<div class="container">
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">&copy; 2016 Rentmarket. All Rights Reserved.</small>
					</p>
					<p>
